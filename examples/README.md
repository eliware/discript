...
| Topic | Examples |
| --- | --- |
| Language fundamentals | [conditionals](fundamentals/conditionals.ds), [loops](fundamentals/loops.ds), [while](fundamentals/while.ds), [control-flow safety](fundamentals/control-flow-safety.ds), [operators](fundamentals/operators.ds), [callbacks](fundamentals/callbacks.ds), [parallel](fundamentals/parallel.ds), [reduce](fundamentals/reduce.ds), [indexed data](fundamentals/indexed-data.ds), [block comments](fundamentals/block-comments.ds) |
