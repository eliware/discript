...
| Topic | Examples |
| --- | --- |
| Language fundamentals | [conditionals](fundamentals/conditionals.ds), [optional and conditional access](fundamentals/optional-and-conditional.ds), [spread values](fundamentals/spread-values.ds), [destructuring](fundamentals/destructuring.ds), [closures](fundamentals/closures.ds), [runtime compatibility](fundamentals/runtime-compatibility.ds), [loops](fundamentals/loops.ds), [while](fundamentals/while.ds), [control-flow safety](fundamentals/control-flow-safety.ds), [operators](fundamentals/operators.ds), [standard library](fundamentals/standard-library.ds), [deferred cleanup](fundamentals/deferred-cleanup.ds), [callbacks](fundamentals/callbacks.ds), [parallel](fundamentals/parallel.ds), [reduce](fundamentals/reduce.ds), [indexed data](fundamentals/indexed-data.ds), [block comments](fundamentals/block-comments.ds) |
| Agent output | [result envelopes](agents/result-envelope.ds), [branching](agents/branch-on-result.ds), [capability-aware mutation](agents/capability-aware-mutation.ds), [CI status](agents/ci-status.ds), [sanitized output](agents/sanitized-output.ds), [resource joins](agents/join-resource-data.ds), [JSONL plans](agents/plan-jsonl.ds), [JSONL monitoring](agent/jsonl-monitor.ds) |
...
| Events | [multiple handlers](events/multiple-handlers.ds), [message monitor](events/message-monitor.ds), [heartbeat](events/heartbeat.ds), [cancellable registrations](events/cancellable-registrations.ds), [JSONL event output](events/event-jsonl-output.ds), [cancellable monitor](events/cancellable-monitor.ds) |
...
| Optimization | [sequential versus parallel](optimization/sequential-vs-parallel.ds), [bounded map](optimization/bounded-map.ds), [retry and timeout](optimization/retry-and-timeout.ds), [cached lookups](optimization/cache-lookups.ds), [REST-first inventory](optimization/rest-first-inventory.ds), [bounded batches](optimization/bounded-batch.ds), [compact output](optimization/compact-agent-output.ds) |
| Composition | [imported functions](composition/imported-functions.ds), [aliased imports](composition/aliased-import.ds), [exported modules](composition/exported-module.ds), [shared formatting](shared/format.ds) |

Additional focused recipes include [async/await](fundamentals/async-await.ds), [script arguments](fundamentals/script-arguments.ds), [object projection](fundamentals/object-projection.ds), [diagnostic call stacks](agents/diagnostic-call-stack.ds), [approval reports](agents/approval-report.ds), [resource selection](agents/resource-selection.ds), [destructive confirmation](safety/destructive-confirmation.ds), [missing-target recovery](safety/missing-target-recovery.ds), [role policy reports](use-cases/role-policy-report.ds), [channel policy reports](use-cases/channel-policy-report.ds), [backup manifests](use-cases/backup-manifest.ds), [read-only plans](optimization/read-only-plan.ds), and [timer plus event workflows](events/timer-and-event.ds).
