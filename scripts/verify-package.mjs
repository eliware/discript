...
try {
  ...
  execFileSync(npmCommand, ['pack', '--pack-destination', directory], { stdio: 'pipe' });
  ...
  execFileSync(npmCommand, ['install', '--ignore-scripts', '--no-audit', '--no-fund', tarball], { cwd: directory, stdio: 'pipe' });
