import { syntaxError } from './parser/errors.mjs';
import { precedence } from './parser/operators.mjs';
import { tokenize } from './parser/tokenizer.mjs';

export { precedence } from './parser/operators.mjs';
